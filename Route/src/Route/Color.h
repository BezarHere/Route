...
namespace route
{
	...
	{
		using value_type = _T;
		using this_type = TColor<_T, _DEFAULT>;
		static constexpr value_type full_value = value_type( _DEFAULT );

		inline constexpr TColor()
			: r{}, g{}, b{}, a{ value_type( full_value ) } {
		}

		inline constexpr TColor( value_type rr, value_type gg, value_type bb, value_type aa = value_type( full_value ) )
			: r{ rr }, g{ gg }, b{ bb }, a{ aa } {
		}
	...
	using Clr8 = TColor<uint8_t, 255>;
	using Clr16 = TColor<uint16_t, 65535>;
